...
For programs that can sample from continuous probability distributions, the formalism needs to be generalized.
Instead of a probability mass function on traces, a probabilistic program defines a probability density function on traces with respect to a certain reference measure.
