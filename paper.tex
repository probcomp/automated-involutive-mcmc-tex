...
(The other values in $x'$ are \emph{implicit copies} via \emph{trace-update}---they could be explicitly copied within $\mathcal{F}$, but this would result in uncessary code and possibly unecessary computation.)
