...
As a concrete example, consider the probabilistic program in Figure~\ref{fig:mixture}b, which defines a Gaussian mixture model with an unknown number of components:
\noindent
\begin{center}
\begin{tabular}{c}
