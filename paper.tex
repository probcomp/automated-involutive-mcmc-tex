...
Recall the ealier code snippet that maps from polar to cartesian coordinates.
...
This section describes how the computation of this probabability is automated by Gen using probabilistic and differentiable programming techniques.
...
(See~\citet{popl} for a formal proof for a somewhat more restricted probabilistic programming language.)
