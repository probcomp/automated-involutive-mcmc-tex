...
\end{center}
Note that the mixture probabilities do not in general cancel, and must be accounted for in the acceptance probability calculation.
...
- using probabilistic programming systems to develop new MCMC algorithms.

- trace translators

- work on compilers for inference programs that generate more specialized, high
  performance implementations, from user specification of an inference
algorithm.
