...
%Applying this to the setting where $Z$ is a set of pairs of traces of probabilistic programs as formalized in the preivous section is straightforward when the partition of $Z$ is the countable disjoint union over all pairs $(K, \mathbf{d})$ where $K \subseteq \mathcal{K}$ are trace structures and $\mathbf{d}$ are assignments to discrete choices.
%
